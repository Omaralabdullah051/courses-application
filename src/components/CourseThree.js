        ...
        >
          ...
          >
            <h2 className="text-[#38BDF8] text-xl lg:text-3xl mb-3">
              Advance Node.JS Course
            </h2>
            <p className="text-xs lg:text-base">
              It's a complete Node.JS course where you will be able to learn
              advance topic of Node.JS.
            </p>
            <p className="text-xs lg:text-base">
            ...
            <p className="text-xs lg:text-sm">
              Express server, Database Integration, GraphQL, HTTP Requests, etc.
            </p>
